...
def latent_patch_metric(cache, layer_ind=28, lat_ind=4611):
...
latent_metric_denoising = partial(_latent_metric, clean_logit_diff=latent_act_clean, corr_logit_diff=latent_act_corrupted, layer_ind=21, lat_ind=1408)
...
_, corr_cache, corr_grad_cache, val = get_cache_fwd_and_bwd_fml(model, clean_tokens, latent_metric_denoising, saes, filtered_ids, 'blocks.21.hook_resid_post')
...
for key in keys:
    ...
    torch.save(resi_attr, f'tasks/error_detection/type/out/second_latents/L21_1408_{key}.pt')
...
with open('tasks/error_detection/type/out/second_latents/top_20_results_L21_1408.json', 'w') as f:
...
# %% 
parent_feat = ["L21_1408", "L28_1800", "L28_2102", "L40_11839"]
second_latents = {}
